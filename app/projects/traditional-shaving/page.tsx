...
const text = {
  en: {
    ...
    subtitle:
      "Custom shaving accessories, stands and decorative objects inspired by classic grooming rituals.",
  ...
  el: {
    title: "TRADITIONAL SHAVING",
    subtitle:
      "Custom αξεσουάρ ξυρίσματος, βάσεις και διακοσμητικά αντικείμενα εμπνευσμένα από το κλασικό ξύρισμα.",
    back: "← Πίσω στα έργα",
    openProject: "Άνοιγμα project →",
  },
};

export default function TraditionalShavingPage() {
