...
const text = {
  en: {
    ...
    intro:
      "Phivimakes started as a place to collect practical objects and designs I created for my own everyday use.",
    ...
    mainText:
      "I design and build everyday objects, custom parts, prototypes and functional solutions mainly through 3D printing. Some projects are small improvements, others are complete custom builds, but they all start from the same idea: creating something useful and personal.",
  },
  ...
  el: {
    ...
    intro:
      "Το phivimakes ξεκίνησε ως ένας χώρος όπου συγκεντρώνω πρακτικά αντικείμενα και σχέδια που δημιούργησα για τη δική μου καθημερινότητα.",
    ...
    mainText:
      "Σχεδιάζω και κατασκευάζω αντικείμενα καθημερινής χρήσης, custom parts, prototypes και λειτουργικές λύσεις κυρίως μέσω 3D printing. Κάποια projects είναι μικρές βελτιώσεις, άλλα είναι ολοκληρωμένες custom κατασκευές, αλλά όλα ξεκινούν από την ίδια ιδέα: να δημιουργηθεί κάτι χρήσιμο και προσωπικό.",
  },
};
